          ...
          <div className="borderBox dropdown padV15" key={index}>
            <div onClick={() => handleDropdown(item.id)} className="heading">
              ...
              {dropdownVisible === item.id ? (
                ...
                <span><svg onClick={() => { handleDropdown(item.id) }} width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="selectedOption">
              ...
              <div
                className={`${dropdownVisible === item.id ? "showDropDown" : "hideDropDown"
                  }`}
              >
                ...
                <div className="optionsContainer">
                  {item?.options?.map((option, index) => (
                    <div className="type-optionCont" key={index}>
                      <input type="checkbox" name={option} id="type-option" onChange={(e) => { handlechange(e, item.id); uncheckedinput(item.id) }} />
